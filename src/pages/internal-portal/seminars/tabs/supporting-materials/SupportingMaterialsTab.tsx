...
import SupportingMaterialsCustomRowActionsComponent from "./custom/SupportingMaterialsCustomRowActions";

function SupportingMaterialsTab() {
  ...
  async function loadData() {
    try {
      ...
      let records = await api.seminarMaterial.getAll(seminarId);
      setRecords(records);
  ...
  return (
    <React.Fragment>
      ...
      <DataGridComponent<FileUpload>
        ...
        RowActions={
          <SupportingMaterialsCustomRowActionsComponent
...
export default SupportingMaterialsTab;

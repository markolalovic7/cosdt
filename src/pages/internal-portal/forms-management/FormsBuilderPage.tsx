...
function FormsBuilderPage() {
  ...
  async function loadData() {
    try {
      ...
      setRecords([]);
      const records = await api.survey.getAll();
      setRecords(records);
  ...
  async function handleUpdate(record: FormSurvey): Promise<void> {
    try {
      ...
      await api.survey.update(updatedRecord);
...
export default FormsBuilderPage;

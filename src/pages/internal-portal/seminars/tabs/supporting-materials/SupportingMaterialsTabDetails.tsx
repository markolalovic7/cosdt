...
function SupportingMaterialsTabDetails() {
  ...
  async function onFinish(rec: FileUpload) {
    try {
      ...
      if (browserFile?.file) {
        ...
        let response = await api.seminarMaterial.create(seminarId, data);
  ...
  return (
    <DataGridModalComponent
      title={"Create supporting material"}
...
export default SupportingMaterialsTabDetails;

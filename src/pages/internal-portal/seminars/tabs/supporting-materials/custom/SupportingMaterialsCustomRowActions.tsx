...
function SupportingMaterialsCustomRowActionsComponent({
  onUpdate,
  onDelete,
  ...
  return (
    <React.Fragment>
      {record && editingId !== record.id && (
        <a
          href={api.seminarMaterial.getFileUrl(record)}
          target="_blank"
...
export default SupportingMaterialsCustomRowActionsComponent;
